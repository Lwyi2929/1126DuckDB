...
# ⭐ 新增：用於儲存當前國家實際人口 MIN/MAX 的響應式變數
...
def load_country_pop_bounds():
    ...
    try:
        ...
        # 將最大值向上取整到最近的 10萬，以獲得更美觀的 Slider 範圍
...
# C. 根據選中的國家篩選城市數據 (邏輯不變，但依賴於 population_range)
